...
-- Создать окно UI
local Window = Library.CreateLib("Helor HUB", "RJTheme6")
...
-- Слайдер
Section:NewSlider("SPEED", "SliderInfo", 1000, 0, function(s) -- 500 (Макс. значение) | 0 (Мин. значение)
...
-- Заголовок
Section:NewLabel("CREDITS: SCRIPTINGERIN")
